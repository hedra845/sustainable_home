...
class _SurveyScreenState extends State<SurveyScreen> {
  ...
  void _submit() {
    ...
    final questions = model.surveyQuestions;
    ...
    model.submitSurvey(_answers).then((_) {
      if (mounted) {
        ...
        ScaffoldMessenger.of(context).showSnackBar(
          SnackBar(
            content: Text(
              Localizations.localeOf(context).languageCode == 'ar'
                  ? 'شكراً لك! تم حفظ إجاباتك بنجاح'
                  : 'Thank you! Your answers have been saved successfully',
            ),
          ),
        );
      }
  ...
  Widget build(BuildContext context) {
    ...
    if (questions.isEmpty) {
      return Scaffold(
        appBar: AppBar(title: Text(AppStrings.get('surveyTitle', context))),
